      ...
      {wallpapers.map((wp) => {
        ...
        return (
          <div 
            ...
            className="mb-6 break-inside-avoid bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-xl hover:border-gray-700 transition group cursor-pointer relative"
          >
            ...
            <div className="relative overflow-hidden bg-gray-800">
              <img
                src={wp.imageUrl}
                alt={wp.title}
                className="w-full h-auto object-cover group-hover:scale-105 transition duration-500 ease-out"
              />
              ...
              <span className="absolute top-3 left-3 bg-black/60 backdrop-blur-md text-white text-xs px-2.5 py-1 rounded-full font-medium group-hover:opacity-0 transition-opacity">
                {wp.category}
              </span>
            </div>
